				...
				<a href="#">
					<div class="d-flex flex-row align-items-center justify-content-start">
						<div class="footer_logo_icon">
							<img height="100"src="<?= base_url('assets/images/logo.jpg') ?>">
						</div>
						<div>C E C E</div>
					</div>
				</a>		
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Made <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="https://github.com/Robbyzhg" target="_blank">Fadil | Adit | Salsa</a>
