...
<body>
	...
	<form action="<?= base_url("register/aksi_login") ?>" method="post">
		...
		<br><br>
		<a href="<?= base_url('register/daftar') ?>" id="signup" style="color:#fff; margin-left:50px;">Don't have account yet?</a>
        <br><br>
		<a href="<?= base_url('registeradmin') ?>" style="color:#fff; margin-left:100px;">Admin?</a>
	</form>
	</div>
</body>
